...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content ">
      ...
      <div class="container ">
      <div className='row '>
      <input type={"email"} placeholder="email" className='col-10 ms-5 emailinput bg mt-3 mb-3' ref={emailref}/>
        
        </div>
        <div className='row '>
      <input type={"password"} placeholder="Password" className='col-10 ms-5  emailinput bg mt-3 mb-4'  ref={passwordref}/>
        
        </div>
        <div className='row '>
      <input type={"button"} value={"sign up"} className='col-10  ms-5 emailinput signupsubmit mt-3 mb-5 '  data-bs-dismiss="modal" onClick={handlesignup} />
